...
public class Game implements Runnable {
    ...
    public static void addCardSlot() {gui.glassPane.addCardSlot();}
    //TO DO - DISCARD CARD.

    public static void removeCardSlot() {gui.glassPane.removeCardSlot();}
    ...
    public static void changeStateToCardPlay() {
        ...
        gui.southPanel.updateSouthPanel();
    }
    ...
    public static void checkEnemyStatus(ArrayList<Enemy> enemies) {
        ...
        for (int i = toRemove.size() - 1; i >= 0; i--) {
            gui.northPanel.removeEnemy(toRemove.get(i));
        }
    }
