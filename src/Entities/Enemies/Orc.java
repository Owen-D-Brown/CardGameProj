...
public class Orc extends Enemy {
    ...
    protected void addMapsToAnimations(String basePath) {
        ...
        animations.add(Tools.importSpritesCutFromLeft(basePath+"IdleMap.png", idleColCount, idleRowCount, 96, 96));
        animations.add(Tools.importSpritesCutFromLeft(basePath+"WalkMap.png", walkColCount, walkRowCount, 96, 96));
        animations.add(Tools.importSpritesCutFromLeft(basePath+"AttackMap.png", attackColCount, attackRowCount, 96, 96));
        animations.add(Tools.importSpritesCutFromLeft(basePath+"DeathMap.png", deathColCount, deathRowCount, 96, 96));
    }
