...
import Entities.Animations.InPlaceAnimation;
...
public abstract class Enemy extends JComponent {
   ...
   //Rpg stats for each Enemy
    ...
    protected void addMapsToAnimations(String basePath) {
        ...
        animations.add(Tools.importSpritesCutFromRight(basePath + "IdleMap.png", idleColCount, idleRowCount, spriteWidth, spriteHeight));
        animations.add(Tools.importSpritesCutFromRight(basePath+"WalkMap.png", walkColCount, walkRowCount, spriteWidth, spriteHeight));
        animations.add(Tools.importSpritesCutFromRight(basePath+"AttackMap.png", attackColCount, attackRowCount, spriteWidth, spriteHeight));
        animations.add(Tools.importSpritesCutFromRight(basePath+"DeathMap.png", deathColCount, deathRowCount, spriteWidth, spriteHeight));
    }
