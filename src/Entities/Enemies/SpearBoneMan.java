...
import Entities.Animations.SpearBoneManAttackAnimation;
...
public class SpearBoneMan extends Enemy {
    ...
    protected void addMapsToAnimations(String basePath) {
        animations.add(importSpritesCutFromLeft("/Resources/SpearBoneMan/SpearIdle.png", idleColCount, idleRowCount, 128, 82));
        animations.add(importSpritesCutFromLeft("/Resources/SpearBoneMan/SpearWalk.png", walkColCount, walkRowCount, 128, 92));
        animations.add(importSpritesCutFromLeft("/Resources/SpearBoneMan/SpearAttack_1.png", attackColCount, attackRowCount, 128, 52));
        animations.add(importSpritesCutFromLeft("/Resources/SpearBoneMan/SpearDead.png", deathColCount, deathRowCount, 107, 82));
    }
