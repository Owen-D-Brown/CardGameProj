...
public class Slime extends Enemy {
    ...
    protected void addMapsToAnimations(String basePath) {
        ...
        animations.add(importSpritesCutFromLeft(basePath+"IdleMap.png", idleColCount, idleRowCount, 128, 128));
        animations.add(importSpritesCutFromLeft(basePath+"WalkMap.png", walkColCount, walkRowCount, 128, 128));
        animations.add(importSpritesCutFromLeft(basePath+"AttackMap.png", attackColCount, attackRowCount, 128, 128));
        animations.add(importSpritesCutFromLeft(basePath+"DeathMap.png", deathColCount, deathRowCount, 128, 128));
    }
