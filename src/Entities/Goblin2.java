...
public class Goblin2 extends Enemy {

    //Dodge chance increments of 15% will be + by agility base stat
    private static final double B_DODGE_CHANCE = 0.15;

    public Goblin2() throws IOException {

        super("Goblin", 40, 8, 1, 0, 2, 100, 100, 600, 500, 8, 1, 6, 1, 6, 1, 6, 1, new GoblinAttackAnimation(), 10);
