...
public class Bow_Card extends Card {


    private static final String IMAGE_PATH = "/Resources/Cards/BowCard.png"; // switch to cards image path


    public Bow_Card() throws IOException {
