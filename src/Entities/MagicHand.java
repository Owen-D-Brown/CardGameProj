...
public class MagicHand extends Card{


    private static final String IMAGE_PATH = "/Resources/Cards/MagicHandCard.png"; // switch to cards image path


    public MagicHand() throws IOException {
